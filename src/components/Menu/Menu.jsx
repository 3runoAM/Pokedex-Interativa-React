...
export default function Menu() {
    return (
        <nav className={`${style.menu} flex-row flex-center mediumPadding`}>
            <Link className={style.menuLink} to={"/home"}>
                <img className={style.menuLogo} src="/pokedex.png" alt="Pokedex"/>
            </Link>
                ...
                <li>
                    <Link to={"/teams"}>
                        <div className={`flex-row flex-center`}>
                            ...
                            <p className={style.label}>Teams</p>
                        </div>
                    </Link>
                </li>
                ...
                <li>
                    <Link to={"/home"}>
                        <div className={`flex-row flex-center`}>
                            ...
                            <p className={`${style.label} ${style.homeLabel}`}>Home</p>
                        </div>
